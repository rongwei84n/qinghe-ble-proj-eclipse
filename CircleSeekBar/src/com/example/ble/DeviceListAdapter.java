	...
	int ip = 0;
		...
		public JDY_type dv_type( byte[] p )
		{
			...
			*/
			...
			byte m1 = (byte)((p[18+2]+1)^0x11);////͸��ģ������λ�ж�
			str = String.format( "%02x", m1 );
			//Log.d( "out_1","="+ str);
			
			byte m2 = (byte)((p[17+2]+1)^0x22);//͸��ģ������λ�ж�
			...
			*/
			...
			if( p[5]==(byte)0xe0 && p[6]==(byte)0xff &&p[11]==m1&&p[12]==m2 &&(dev_VID==p[19-6])  )//JDY
			{
				...
				else if( p[20-6]==(byte)0xa5 )return JDY_type.JDY_AMQ;//��Ħ��
				else if( p[20-6]==(byte)0xb1 )return JDY_type.JDY_LED1;// LED��
				else if( p[20-6]==(byte)0xb2 )return JDY_type.JDY_LED2;// LED��
				else if( p[20-6]==(byte)0xc4 )return JDY_type.JDY_KG;// ���ؿ���
				else if( p[20-6]==(byte)0xc5 )return JDY_type.JDY_KG1;// ���ؿ���
...
//				 Log.d( "JDY_type.JDY_19=","IB"+list_cell_0.bytesToHexString1( WriteBytes1 ) );
				/*
				if( p[57]==(byte)0xe0 ){return JDY_type.JDY_iBeacon;}//iBeaconģʽ
				else if( p[57]==(byte)0xe1 ){return JDY_type.sensor_temp;}////�¶ȴ�����
				else if( p[57]==(byte)0xe2 ){return JDY_type.sensor_humid;}////ʪ�ȴ�����
				else if( p[57]==(byte)0xe3 ){return JDY_type.sensor_temp_humid;}////ʪʪ�ȴ�����
				else if( p[57]==(byte)0xe4 ){return JDY_type.sensor_fanxiangji;}////�������ˮ������ʾ��
				else if( p[57]==(byte)0xe5 ){return JDY_type.sensor_zhilanshuibiao;}////����ˮ��������������
				else if( p[57]==(byte)0xe6 ){return JDY_type.sensor_dianyabiao;}////��ѹ������
				else if( p[57]==(byte)0xe7 ){return JDY_type.sensor_dianliu;}////����������
				else if( p[57]==(byte)0xe8 ){return JDY_type.sensor_zhonglian;}////���ش�����
				else if( p[57]==(byte)0xe9 ){return JDY_type.sensor_pm2_5;}////PM2.5������
				*/
