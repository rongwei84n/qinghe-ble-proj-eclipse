...
public class BluetoothLeService extends Service {
    ...
    public enum function_type {
    	iBeacon_UUID, //0xe1  ����iBeacon UUID
    	iBeacon_Major,//0xe2/����iBeacon Major
    	iBeacon_Minor,//0XE3:����iBeacon Minor
    	adv_intverl,//0XE4:���ù㲥���
    	pin_password,//0XE5:��������   ����ֻ��Ϊ4λ����       0XE5://��������
    	name,//0XE6:---------------------------------�豸��  
    	GPIO,//0XE7:IO����
    	PWM,// 0XE8:PWM����
    	Other,//0XE9:��λģ�顢�Ͽ���������ȡģ��İ汾
    	Power,//0XEA:�豸����
    	RTC,//0XEB:RTC����
    ...
    public String bytesToHexString1(byte[] src,int index )//����byte[]��0x11,0x22,0x33,0x44,0x55,0x66  ת����String:��11 22 33 44 55 66��
    {  
	...
	public String String_to_HexString0( String str )//����String��123456�� ת����String����313233343536��
	{
	...
	public String String_to_HexString( String str )//����String��123456�� ת����String����31 32 33 34 35 36��
	{
     	String st =str.toString();
    	byte[] WriteBytes = new byte[st.length()];
    	WriteBytes = st.getBytes();
	...
	public byte[] String_to_byte( String str )//����String��123456�� ת����byte[]��0x31,0x32,0x33,0x34,0x35,0x36
	{
     	String st =str.toString();
    	byte[] WriteBytes = new byte[st.length()];
    	return WriteBytes;
	...
	public String byte_to_String( byte[] byt )//����byte[]��0x31,0x32,0x33,0x34,0x35,0x36  ת����String:��123456��
	{
	 String t = new String( byt );//bytep[]ת��ΪString
	 return t;
	}
	public String byte_to_String( byte[] byt,int index )//����byte[]��0x31,0x32,0x33,0x34,0x35,0x36  ת����String:��123456��
	{
		if( byt==null )return null;
		byte[] WriteBytes = new byte[ byt.length-index ];
		for( int i=index;i<byt.length;i++ )
			WriteBytes[ i-index ]=byt[i];
	 String t = new String( WriteBytes );//bytep[]ת��ΪString
	 return t;
	}
...
//        	mBluetoothGatt.setCharacteristicNotification(jdy, p);
    ...
    public boolean get_password( String password )//��ȡ�豸����
    {
    	boolean p = true;
    ...
    public boolean set_password( String password,String new_password )//��ȡ�豸����
    {
    	boolean p = true;
...
//    public boolean set_name_hz( String name )//�����豸��
//    {
//    	boolean p = true;
...
//		return p;
//    }
    public boolean set_name( String name )//�����豸��
    {
    	boolean p = true;
    	if( name==null)return false;
    ...
    public boolean MC_set_password( String password,String new_password )//��ȡ�豸����
    {
    	boolean p = true;
    	if( password==null||new_password==null )return false;
    	//else if( password.length()!=6||new_password.length()!=6 )return false;
    ...
    public boolean set_IO1( boolean p )//����IO1��ƽ
    {
    	boolean p11 = true;
    	String txt="E7f1";
    	if( p )txt=txt+"01";
    ...
    public boolean set_IO2( boolean p )///����IO2��ƽ
    {
    	boolean p11 = true;
    	String txt="E7f2";
    	if( p )txt=txt+"01";
    ...
    public boolean set_IO3( boolean p )///����IO3��ƽ
    {
    	boolean p11 = true;
    	String txt="E7f3";
    	if( p )txt=txt+"01";
    ...
    public boolean set_IO4( boolean p )///����IO4��ƽ
    {
    	boolean p11 = true;
    	String txt="E7f4";
    	if( p )txt=txt+"01";
    ...
    public boolean set_IO_ALL( boolean p )///����IO4��ƽ
    {
    	boolean p11 = true;
    	String txt;
    	if( p )txt="E7f5";
    ...
    public void get_IO_ALL(  )///��ȡ4·IO״̬
    {
    	String txt="E7f6";
    	WriteBytes= hex2byte( txt.toString().getBytes() );
    	BluetoothGattCharacteristic gg;
    ...
    public void set_APP_PASSWORD( String pss )///����APP��������
    {
    	boolean p11 = true;
    	String txt="E555";
    ...
    public boolean set_ibeacon_UUID( String uuid )//����iBeacon UUID
    {
    	if( uuid.length()==36 )
		{
			String v1="",v2="",v3="",v4="";
    ...
    public boolean set_ibeacon_MAJOR( String major )//����iBeacon Major
    {
    ...
    public boolean set_ibeacon_MIMOR( String minor )//����iBeacon Minor
    {
    ...
    public void set_BroadInterval( int interval )///���ù㲥���
    {
    	String txt="E441";
    ...
    public void get_BroadInterval(  )///��ȡ�㲥���
    {
    	String txt="E442";
    	WriteBytes= hex2byte( txt.toString().getBytes() );
    	BluetoothGattCharacteristic gg;
    ...
    public void set_PWM_OPEN( int pwm )//����PWM����
    {
    	String txt="E8a1";
    ...
    public void set_PWM_frequency( int frequency )//����PWMƵ��
    {
    	String txt="E8a2";
    ...
    public void set_PWM1_pulse( int pulse )//����PWM1����
    {
    	String txt="E8a3";
    ...
    public void set_PWM2_pulse( int pulse )//����PWM2����
    {
    	String txt="E8a4";
    	String vs=String.format("%02x", pulse );
    	txt =txt+vs;
    ...
    public void set_PWM3_pulse( int pulse )//����PWM3����
    {
    	String txt="E8a5";
    	String vs=String.format("%02x", pulse );
    	txt =txt+vs;
    ...
    public void set_PWM4_pulse( int pulse )//����PWM4����
    {
    	String txt="E8a6";
    	String vs=String.format("%02x", pulse );
    	txt =txt+vs;
    ...
    public void set_PWM_ALL_pulse( int PWM1_pulse,int PWM2_pulse,int PWM3_pulse,int PWM4_pulse )//����PWM4����
    {
    	String txt="E8a7";
    ...
    public void set_AV_OPEN( int p )//����AV������ģʽ
    {
    	String txt="E9a501";
    ...
    public void set_AV_PULSE( int p )//����AV������ģʽ
    {
    	String txt="E9a502";
    	String vs=String.format("%02x", p );
    	txt =txt+vs;
    ...
    public void set_LED_Mode( int i )//�豸LED����ģʽ   ����LED��ģʽ ������--�����ģʽ = 51���̶�ģʽ =��1-25�����Զ���ģʽ = 50
    {
    	String txt="E9b101";
    	String vs=String.format("%02x", i );
    	txt =txt+vs;
    ...
    public void set_LED_Brightness( int i )//�豸����( 0 - 255 )
    {
    	String txt="E9b102";
    	String vs=String.format("%02x", i );
    	txt =txt+vs;
    ...
    public void set_LED_T_J_F( int i )//����LED��( ����=1������=2��Ƶ��=3 ��
    {
    	String txt="E9b103";
    	String vs=String.format("%02x", i );
    	txt =txt+vs;
    ...
    public void set_LED_Speed( int i )//����LED���ٶ�  ( 0-100 )
    {
    	String txt="E9b104";
    	String vs=String.format("%02x", i );
    	txt =txt+vs;
    ...
    public void set_LED_Custom_LEN( int i )//�����Զ���ģʽ�����ݳ���
    {
    	String txt="E9b1A0";
    	String vs=String.format("%02x", i );
    	txt =txt+vs;
    ...
    public boolean set_LED_Custom1( String dd )//�����Զ���ģʽ������1
    {
    ...
    public boolean set_LED_Custom2( String dd )//�����Զ���ģʽ������2
    {
    	if( dd==null )return false;
    	int len = dd.length();
    	if( len==24 )
    ...
    public boolean set_LED_Custom3( String dd )//�����Զ���ģʽ������3
    {
    	if( dd==null )return false;
    	int len = dd.length();
    	if( len==24 )
    ...
    public boolean set_LED_Custom4( String dd )//�����Զ���ģʽ������4
    {
    	if( dd==null )return false;
    	int len = dd.length();
    	if( len==24 )
    ...
    public boolean set_LED_PAD_color( String dd )//���������ɫ 
    {
    	if( dd==null )return false;
    	int len = dd.length();
    	if( len==8 )
    ...
    public void set_LED_OPEN( boolean p )//���������ɫ 
    {
