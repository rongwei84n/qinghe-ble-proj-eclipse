...
//       // mDataField = (TextView) findViewById(R.id.data_value);
        ...
        key1.setOnClickListener( listener );//���ü���  
        key2.setOnClickListener( listener );//���ü���  
        key3.setOnClickListener( listener );//���ü���  
        key4.setOnClickListener( listener );//���ü���  
        
     
        switch_password_write = (Button)findViewById(R.id.switch_password_write);
        switch_password_write.setOnClickListener( listener );//���ü���  
...
//        switch_pass_value = (EditText)findViewById(R.id.switch_pass_value);
        ...
        boolean sg;
        getActionBar().setTitle(mDeviceName + "  ���ؿ�����");
    ...
    Button.OnClickListener listener = new Button.OnClickListener(){//������������    
        public void onClick(View v){    
        	...
        	case R.id.switch_password_write:
        	{
        		...
        		if( mBluetoothLeService.set_name( switch_new_name_value.getText().toString() ) )//֧������������
        		{
        			
        		}else switch_status_txt.setText("�豸������Ϊ��");
        	...
        	case R.id.imageButton1:
        	{
        		if( mConnected==true )
        		{
	        		...
	        		mBluetoothLeService.get_IO_ALL(  );//��ȡ����IO״̬��4·IO��
        		}
        	}break;
...
int len_g = 0;
    ...
    private void displayData1( byte[] data1 ) //����FFE2�������÷��ص�����
    {
    	...
    	if( data1.length==2&&data1[0]==(byte) 0x61 )//�����豸���ɹ�
    	{
    		...
    		{
    			switch_status_txt.setText( "�豸�����³ɹ�" );
    			//Toast.makeText(jdy_ibeacon_Activity.this, "�豸�����³ɹ�", Toast.LENGTH_SHORT).show(); 
    		}
    		else 
    		{
    			switch_status_txt.setText( "�豸������ʧ��" );
    			//Toast.makeText(jdy_ibeacon_Activity.this, "�豸������δ�ɹ�", Toast.LENGTH_SHORT).show(); 
    		}
    	}
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
	        ...
	        if( connect_status_bit )
			  {
	        	...
	        	show_view( true );
				 ...
				 updateConnectionState(R.string.connected);
				  ...
				  Toast toast = Toast.makeText(jdy_switch_Activity.this, "�豸û�����ӣ�", Toast.LENGTH_SHORT); 
				  toast.show(); 
			  }
        }
        ...
        {
        	 Toast toast = Toast.makeText(jdy_switch_Activity.this, "��ʾ�����豸��ΪJDYϵ��BLEģ��", Toast.LENGTH_SHORT); 
			  toast.show(); 
        }
