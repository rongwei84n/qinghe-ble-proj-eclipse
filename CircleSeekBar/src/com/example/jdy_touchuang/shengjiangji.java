    ...
    //    ((TextView) findViewById(R.id.device_address)).setText(mDeviceAddress);
     ...
     //   mConnectionState = (TextView) findViewById(R.id.connection_state);
       // mDataField = (TextView) findViewById(R.id.data_value);
        ...
        sjj_down_button.setOnClickListener( OnClickListener_listener );//���ü���  
        sjj_cent_button.setOnClickListener( OnClickListener_listener );//���ü���  
        sjj_up_button.setOnClickListener( OnClickListener_listener );//���ü���  
        ...
        public void onClick(View v){    
        	...
        	case R.id.tx_button ://uuid1002 ����ͨ����������
        		...
        		if( mConnected )
        		{
      			  ...
      			  Toast toast = Toast.makeText(shengjiangji.this, "�豸û�����ӣ�", Toast.LENGTH_SHORT); 
      			  toast.show(); 
      		  }
        		break;
...
//    		}
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        {
        	 Toast toast = Toast.makeText(shengjiangji.this, "��ʾ�����豸��ΪJDYϵ��BLEģ��", Toast.LENGTH_SHORT); 
			  toast.show(); 
        }
