...
//                    }
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
       ...
       // mGattServicesList.setOnChildClickListener(servicesListClickListner);
        ...
        timer.schedule(task, 5000, 5000); // 1s��ִ��task,����1s�ٴ�ִ��  
        ...
        public void onClick(View v){    
        	...
        	case R.id.tx_button ://uuid1002 ����ͨ����������
        		if( connect_status_bit )
      		  {
      			  ...
      			  Toast toast = Toast.makeText(jdy_sensor_temp_Activity.this, "�豸û�����ӣ�", Toast.LENGTH_SHORT); 
      			  toast.show(); 
      		  }
        		break;
...
int len_g = 0;
    ...
    private void displayData1( String data1 ) //����FFE2�������÷��ص�����
    {
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        {
        	 Toast toast = Toast.makeText(jdy_sensor_temp_Activity.this, "��ʾ�����豸��ΪJDYϵ��BLEģ��", Toast.LENGTH_SHORT); 
			  toast.show(); 
        }
